...
#
# Part 1:  - Consider only horizontal and vertical lines. At how many points do at least
#            two lines overlap?
# Part 2:  - Consider all of the lines, i.e, even diagonals. At how many points do at 
